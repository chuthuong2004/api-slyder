export default (title, titleMessage) => {
    //     var html = "";
    ...
    //     var msg = `<div style="background: #00796b; display: flex;flex-direction: row;">
    ...
    //     <h4>[Đơn hàng #${order._id}] (${moment(order.createdAt).format(
    //     "DD/MM/YYYY HH:mm:ss"
    //   )})</h4>
    ...
    //             </td>
    //             <td style="border: 1px solid #bdbdbd;border-collapse: collapse;padding: 4px 8px;"><b>${order.totalPrice
    //               .toString()
    //               .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}đ</b></td>
    //         </tr>
    //         <tr>
    //             <td style="border: 1px solid #bdbdbd;border-collapse: collapse;padding: 4px 8px;" colspan="3" style="text-align:left">Phí vận chuyển:
    //             </td>
    //             <td style="border: 1px solid #bdbdbd;border-collapse: collapse;padding: 4px 8px;"><b>${order.shippingPrice
    //               .toString()
    //               .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}đ</b></td>
    //         </tr>
    //         <tr>
    ...
    //     <p>${order.shippingInfo.fullName} <br>${order.shippingInfo.address.split(",")[0]}<br>${
    //     order.shippingInfo.address.split(",")[1]
    //   }<br>${order.shippingInfo.address.split(",")[2]}<br>${
    //     order.shippingInfo.address.split(",")[3]
    //   }<br>${order.shippingInfo.phone}<br>${order.user.email}                </p>
    //     </div>
